...
namespace SpeedRead81
{
    public partial class Editor : Page
    {
        ...
        void Editor_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            Color[] cColors = new Color[] { Colors.Red, Colors.Blue, Colors.Yellow, Colors.White, Colors.Green, Colors.Orange , Colors.Purple , Colors.Brown , Colors.LightGoldenrodYellow , Colors.Black };
